...
int main()
{
	...
	double Tot2010 = 0, Tot2011 = 0, Tot2012 = 0, Num2010 = 0, Num2011 = 0, Num2012 = 0, Steepness2010, Temp1 = 0, Temp2 = 0, Temp3 = 0;
	...
	for (int i = 0; i < 50; i++) {
		...
		if (array[5] != 0 and array[6] != 0) {
			...
			if (array[i][0] == 2012) {
				...
				if (array[i][5] / array[i][6] > Temp3) {

						Temp3 = array[i][5] / array[i][6];
